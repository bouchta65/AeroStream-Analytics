...
from aggregation_service import (
    get_tweets_by_ccompagnie,
    get_sentiment_by_companie,
    get_pourcentage_satisfaction,
    get_reason_negative,
    get_count_tweets,
    get_count_companie,
    pourcentage_negative_tweets,
)
...
def get_aggregations():
    return {
    "get_tweets_by_ccompagnie" : get_tweets_by_ccompagnie(),
    "get_sentiment_by_companie" : get_sentiment_by_companie(),
    "get_pourcentage_satisfaction" : get_pourcentage_satisfaction(),
    "get_reason_negative" :get_reason_negative(),
    "get_count_tweets" : get_count_tweets(),
    "get_count_companie" : get_count_companie(),
    "pourcentage_negative_tweets" : pourcentage_negative_tweets()
    }